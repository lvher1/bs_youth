...
class MyQT extends StatefulWidget {
  const MyQT({Key? key}) : super(key: key);

  @override
  State<MyQT> createState() => _MyQT();
}

class _MyQT extends State<MyQT> {
    ...
    return Scaffold(
      ...
      body: StreamBuilder(
        stream: FirebaseFirestore.instance
            .collection('QuietTime')
            .where("uid",isEqualTo: currentUser.currentUser!.email.toString())
            .snapshots(),
        builder: (BuildContext context,
