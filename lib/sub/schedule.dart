...
class Content {
  ...
  Content(
      {required this.content, required this.date, required this.downloadurl, required this.firstDate, required this.lastDate});
...
class _Schedule extends State<Schedule> {
  ...
  uploadFile() async {
    if (_image == null) {
      ...
      Reference ref =
      FirebaseStorage.instance.ref().child('schedule/${_image?.name}');
  ...
  _save() async {
    ...
    try {
      ...
      Content content = Content(
          ...
          downloadurl: downloadurl!,
          firstDate: dateFormat2.format(_first!) ,
          lastDate: dateFormat2.format(_last!)
      );
                      ...
                      child: Row(
                        ...
                        children: <Widget>[
                          Row(
                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            children: <Widget>[
                              Text(data.docs[index].data().firstDate
                              ),
                              Text('~'),
                              Text(data.docs[index].data().lastDate)
                              /*IconButton(
